...
export default function ResetPasswordEmail({
  ...
  return (
    ...
    >
      ...
      <Text style={styles.paragraph}>
        We received a request to reset your password for the account associated with{' '}
        <span style={styles.strong}>{email}</span>. Use the OTP below. This code expires in{' '}
      ...
      <Text style={styles.smallText} className='text-gray-400'>
        <span style={styles.strong}>Need to confirm</span>
        <br />
        If you did not request a password reset, you can safely ignore this email. For extra help, contact{' '}
