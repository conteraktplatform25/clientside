...
export const sfProRounded = localFont({
  src: [
    {
      path: '/fonts/sf-pro-rounded/SF-Pro-Rounded-Thin.woff2',
      weight: '100',
      style: 'normal',
    },
    {
      path: '/fonts/sf-pro-rounded/SF-Pro-Rounded-Ultralight.woff2',
      weight: '200',
      style: 'normal',
    },
    {
      path: '/fonts/sf-pro-rounded/SF-Pro-Rounded-Light.woff2',
      weight: '300',
      style: 'normal',
    },
    {
    ...
    {
      path: '/fonts/sf-pro-rounded/SF-Pro-Rounded-Black.woff2',
      weight: '900',
      style: 'normal',
    },
  ],
