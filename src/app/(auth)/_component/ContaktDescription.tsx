...
const ContaktDescription = () => {
  return (
    <section className='hidden md:flex flex-1 bg-primary-900 text-white flex-col item-center justify-end gap-12 text-center p-1 overflow-hidden'>
      {/* Spacer to push content towards the center/bottom */}
      <div className='flex-grow h-full'>
        <div className='h-full mb-16 relative flex justify-center items-center mt-8 w-full'>
          {/* Card 1 (background) */}
...
export default ContaktDescription