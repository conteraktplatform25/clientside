...
const ProductCard: React.FC<ProductCardProps> = ({ product }) => {
  return (
    <Card className='p-0 w-full max-w-xs rounded-lg overflow-hidden shadow-none transition-shadow duration-200'>
          ...
          <div className='flex items-center justify-between'>
            ...
            <span
              className={cn(
                ...
                product.availability === 'Available' ? 'bg-green-50 text-green-700' : 'bg-red-50 text-red-700'
              )}
            >
